...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl>
       <a href="/shop/tp/index.php/Admin/Brand/brand_add" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus">添加品牌</a>
      </dl>
      <!--这里打开的是新页面-->
    ...
    <form class="am-form am-g">
          <table class="am-table am-table-bordered am-table-radius am-table-striped" width="100%" id="datalist">
            ...
            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                <td><input type="checkbox" class="son" value="<?php echo ($vo["brand_id"]); ?>" name="check"></td>
                <td><?php echo ($vo["brand_id"]); ?></td>
                <td><a href="#"><?php echo ($vo["brand_name"]); ?></a></td>
                <td><img src="/shop/tp/Uploads<?php echo ($vo["brand_logo"]); ?>" alt="" width="100" height="60"></td>
                <td class="am-hide-sm-only"><?php echo ($vo["brand_desc"]); ?></td>
                <td class="am-hide-sm-only"><?php echo ($vo["site_url"]); ?></td>
                <td class="am-hide-sm-only"><?php echo ($vo["sort"]); ?></td>
                <td class="am-hide-sm-only"><?php echo ($vo["is_show"]); ?></td>
                <td>
