...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl>
       <a href="/shop/tp/index.php/Admin/Goods/cate_add" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus">添加分类</a>
      </dl>
      <!--这里打开的是新页面-->
    ...
    <form class="am-form am-g" action="/shop/tp/index.php/Admin/Goods/goods_sku" method="post">
          <table class="am-table am-table-bordered am-table-radius am-table-striped" width="100%" id="datalist">
            
              <tr class="am-success">
                <?php if(is_array($attr_name)): foreach($attr_name as $k=>$v): ?><td><?php echo ($v); ?></td><?php endforeach; endif; ?>
                <td class="table-title">货号</th>
                <td class="table-author am-hide-sm-only">SKU</td>
                <td class="table-set" width="130px">操作</td>
              </tr>
           
           
              <tr>
              <?php if(is_array($attr_val)): foreach($attr_val as $k=>$vs): ?><td>
              <select name="attr_list[<?php echo ($k); ?>][]" id="">
              <?php if(is_array($vs)): foreach($vs as $key=>$vv): ?><option value="<?php echo ($vv["goods_attr_id"]); ?>,<?php echo ($vv["pro_price"]); ?>"><?php echo ($vv['attr_val']); ?></option><?php endforeach; endif; ?>
              </select>

                </td><?php endforeach; endif; ?>
                <td><input type="text" name="product_sn[]"></td>
                <td class="am-hide-sm-only"><input type="text" name="product_sku[]">
                ...
                <td>
                	...
                	<div class="am-btn-toolbar">
                      <button type="button" class="add" title="删除订单"><span>[+]</span></button>
                    </div>
                  </div>
                </td>
              </tr>
  ...
  <script>
    ...
    $('.add').click(function(){
      ...
      html = html.replace('[+]','[--]');
      $(this).parents('tr').after("<tr>"+html+"</tr>")
    ...
    $(document).on("click",".del",function(){
      $(this).parents('tr').remove();
              ...
              <button type="submit" class="am-btn am-btn-default" id="shan"><span class="am-icon-plus"></span>库存合并</button>
