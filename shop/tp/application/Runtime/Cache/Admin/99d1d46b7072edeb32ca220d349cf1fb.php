...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-flag on">分类信息</ul>
    ...
    <div class="fbneirong">
      <form class="am-form" method="post"  action="/shop/tp/index.php/Admin/Category/cate_edit" >
        <div class="am-form-group am-cf">
          <div class="zuo">分类名称：</div>
          <div class="you">
            <input class="am-input-sm" name="cat_name" id="doc-ipt-email-1" value="<?php echo ($data["cat_name"]); ?>" type="text">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">分类描述：</div>
          <div class="you">
            <textarea class="" rows="2" id="doc-ta-1" value="<?php echo ($data["cat_desc"]); ?>" name="cat_desc"><?php echo ($data["cat_desc"]); ?></textarea>
          </div>
        </div>
        <div class="am-form-group am-cf">
          ...
          <select name="parent_id" id="">
			...
			<?php if(is_array($data)): foreach($data as $key=>$v): ?><option value="<?php echo ($v["cat_id"]); ?>"><?php echo ($v["level"]); echo ($v["cat_name"]); ?></option><?php endforeach; endif; ?>
          </select>
          </div>
        </div>
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you">
          <input class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入标题" type="text" name="sort">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">是否导航栏展示：</div>
          <div class="you">
         <input type="radio" name="is_nav" value="1">展示
         <input type="radio" name="is_nav" value="0">不展示
          </div>
        </div>
         <div class="am-form-group am-cf">
          <div class="zuo">是否前台展示：</div>
          <div class="you">
