...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-users"> 类型管理</ul>
      
      <dl class="am-icon-home" style="float: right;">当前位置： 首页 &gt; <a href="#">类型列表</a></dl>
      
      <dl>
       <a href="/shop/tp/index.php/Admin/Type/type_add" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus">添加类型</a>
      </dl>
      <!--这里打开的是新页面-->
    ...
    <form class="am-form am-g">
          <table class="am-table am-table-bordered am-table-radius am-table-striped" width="100%" id="datalist">
              ...
              <tr class="am-success">
                ...
                <td class="table-title">类型名称</th>
                <td class="table-author am-hide-sm-only">属性个数</td>           
                <td class="table-set" width="130px">操作</td>
              </tr>
           
            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                <td><input type="checkbox" class="son" value="<?php echo ($vo["goods_type_id"]); ?>" name="check"></td>
                <td class="am-hide-sm-only"><?php echo ($vo["goods_type_id"]); ?></td>
                <td class="am-hide-sm-only"><?php echo ($vo["type_name"]); ?></td>
                <td class="am-hide-sm-only"><?php echo ($vo["k"]); ?></td>
                <td>
                      	
                	<div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="<?php echo U('Attr/attr_list');?>?id=<?php echo ($vo["goods_type_id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-success am-round"><span class="am-icon-search" title="属性列表"></span></a>
