...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;">当前位置： 首页 &gt; <a href="#">属性列表</a></dl>
            ...
            <?php if(is_array($attr_list)): foreach($attr_list as $key=>$vo): ?><tr>
                ...
                <td>
                    ...
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="/shop/tp/index.php/Admin/Type/sel_type_list?id=<?php echo ($vo["goods_type_id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-success am-round"><span class="am-icon-search" title="属性列表"></span>属性列表</a>
