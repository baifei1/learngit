    ...
    <form class="am-form am-g">
          <table class="am-table am-table-bordered am-table-radius am-table-striped" width="100%" id="datalist">
            ...
            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                ...
                <td class="am-hide-sm-only"><?php echo ($vo["goods_sn"]); ?></td>
                <td class="am-hide-sm-only"><?php echo ($vo["shop_price"]); ?></td>
                <td class="am-hide-sm-only"><?php if($vo["is_is_on_sale"] == 1): ?>✔<?php else: ?>×<?php endif; ?></td>
                <td class="am-hide-sm-only"><?php if($vo["is_best"] == 1): ?>✔<?php else: ?>×<?php endif; ?></td>
                <td class="am-hide-sm-only"><?php if($vo["is_new"] == 1): ?>✔<?php else: ?>×<?php endif; ?></td>
                <td class="am-hide-sm-only"><?php if($vo["is_hot"] == 1): ?>✔<?php else: ?>×<?php endif; ?></td>
                <td class="am-hide-sm-only"><?php echo ($vo["goods_number"]); ?></td>
                <td>
                      	
                	<div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="<?php echo U('Goods/goods_sku');?>?goods_id=<?php echo ($vo["goods_id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-success am-round"><span class="am-icon-search" title="货品列表"></span> </a>
