...
<div class="admin-biaogelist">
    ...
    <div class="fbneirong">
      <form class="am-form" method="post"  action="/shop/tp/index.php/Admin/Category/cate_add" >
        <div class="am-form-group am-cf">
          <div class="zuo">分类名称：</div>
          <div class="you">
            <input class="am-input-sm" name="cat_name" id="doc-ipt-email-1" placeholder="请输入名称" type="text">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">分类描述：</div>
          <div class="you">
            <textarea class="" rows="2" id="doc-ta-1" name="cat_desc"></textarea>
          </div>
        </div>
        <div class="am-form-group am-cf">
          ...
          <select name="parent_id" id="">
			...
			<?php if(is_array($cate)): foreach($cate as $key=>$v): ?><option value="<?php echo ($v["cat_id"]); ?>"><?php echo ($v["level"]); echo ($v["cat_name"]); ?></option><?php endforeach; endif; ?>
          </select>
          </div>
        </div>
