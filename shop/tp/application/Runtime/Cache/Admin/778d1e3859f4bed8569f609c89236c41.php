...
<div class="admin-biaogelist">
    ...
    <div class="fbneirong">
      <form class="am-form" method="post"  action="/shop/tp/index.php/Admin/Brand/brand_add" enctype="multipart/form-data">
        <div class="am-form-group am-cf">
          <div class="zuo">品牌名称：</div>
          <div class="you">
            <input class="am-input-sm" name="brand_name" id="doc-ipt-email-1" placeholder="请输入名称" type="text">
          </div>
        </div>
         <div class="am-form-group am-cf">
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you">
          <input class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入网址" type="text" name="site_url">
          </div>
        </div>
