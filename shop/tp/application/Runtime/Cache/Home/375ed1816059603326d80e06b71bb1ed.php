...
<link type="text/css" href="/shop/tp/Public/Home/css/optstyle.css" rel="stylesheet" />
<link type="text/css" href="/shop/tp/Public/Home/css/style.css" rel="stylesheet" />

<script type="text/javascript" src="/shop/tp/Public/Home/basic/js/quick_links.js"></script>

<script type="text/javascript" src="/shop/tp/Public/Home/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
<script type="text/javascript" src="/shop/tp/Public/Home/js/jquery.imagezoom.min.js"></script>
<script type="text/javascript" src="/shop/tp/Public/Home/js/jquery.flexslider.js"></script>
<script type="text/javascript" src="/shop/tp/Public/Home/js/list.js"></script>
				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="/shop/tp/Public/Home/images/01.jpg" title="pic" />
								</li>
								<li>
									<img src="/shop/tp/Public/Home/images/02.jpg" />
								</li>
								<li>
									<img src="/shop/tp/Public/Home/images/03.jpg" />
								</li>
							</ul>
						</div>
					</section>
				...
				<div class="item-inform">
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="javascript:void(0)"><img src="/shop/tp/Uploads<?php echo ($goods_info["goods_img"]); ?>" alt="细节展示放大镜特效" rel="/shop/tp/Uploads<?php echo ($goods_info["goods_img"]); ?>" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
							<?php if(is_array($goods_gallery)): foreach($goods_gallery as $key=>$v): ?><li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="javascript:void(0)"><img src="/shop/tp/Uploads<?php echo ($v['thumb_img']); ?>" mid="/shop/tp/Uploads<?php echo ($v['thumb_img']); ?>" big="/shop/tp/Uploads<?php echo ($v['thumb_img']); ?>"></a>
									</div>
				 ...
				 <!-- 商品售价 -->
				 <input type="hidden" name="shop_price" value="<?php echo ($goods_info["shop_price"]); ?>">
	          </h1>
						</div>
						<div class="tb-detail-list">
							<!--价格-->
							<div class="tb-detail-price">
							<?php if(isset($goods_info['is_promote'])): if($goods_info == 1): ?><li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">56.90</b>  </dd>                                 
								</li><?php endif; endif; ?>
								<li class="price iteminfo_price">
									<dt>现价</dt>
									<dd><em>¥</em><b class="sys_item_price end_price"><?php echo ($goods_info["shop_price"]); ?></b>  </dd>                                 
								</li>
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice"><?php echo ($goods_info["market_price"]); ?></b></dd>									
								</li>
								<div class="clear"></div>
							</div>
...
<div class="theme-signin-left">
	...
	<?php if(is_array($attr_info)): foreach($attr_info as $key=>$v): ?><div class="theme-options attr_info">
		<div class="cart-title"><?php echo ($v['attr_name']); ?></div>
		<ul>
		<?php if(is_array($v['attr_val'])): foreach($v['attr_val'] as $key=>$vs): ?><li class="sku-line " goods_attr_id="<?php echo ($vs['goods_attr_id']); ?>"><?php echo ($vs['attr_value']); ?><i></i></li><?php endforeach; endif; ?>
		</ul>
	</div><?php endforeach; endif; ?>
	<div class="theme-options">
		<div class="cart-title number">数量</div>
		<dd>
			<input id="min" class="am-btn am-btn-default min" name="" type="button" value="-" />
			<input id="text_box" name="buy_num" type="text" value="1" style="width:30px;" />
			<input id="add" class="am-btn am-btn-default add" name="" type="button" value="+" />
			<span id="Stock" class="tb-hidden">库存<span class="stock sku"><?php echo ($goods_info['goods_number']); ?></span>件</span>
		</dd>
...
<script>
$(function(){
	$(".theme-signin").click(function(){
		var sku =$('.sku');
		var ids="";
		var check=true;
		var obj=$(this).find(".attr_info")
		obj.each(function(k,v){
			var id = $(v).find("li[class$=' selected']").attr('goods_attr_id');
		...
		$.ajax({
			type:"post",
			url:"/shop/tp/index.php/Home/Goods/get_sku",
			data:{
				"attr_list":ids,
			},
			dataType:"json",
			success:function(msg){
				if(msg.error==0){
					$("input[name='pro_list']").val(ids);
					sku.html(msg.content.pro_sku);
					shop_price = $("input[name='shop_price']").val();
					var end_price =0
					end_price = parseInt(shop_price)+parseInt(msg.content.pro_price);
					$(".end_price").text(end_price);
				}else{
					$("input[name='pro_list']").val("");
					sku.html(msg.content);
				}
			}
		})
	})
...
$(document).ready(function(){
	...
	//数量减少操作
	$(".add").click(function(){
			var t = parseInt($("#text_box").val());
			// alert(t)
			var sku = parseInt($(".sku").text());
			if(t>=sku){
				// t.attr(sku).val()
...
<div class="theme-signin-right">
	<div class="img-info">
		<img src="/shop/tp/Public/Home/images/songzi.jpg" />
	</div>
	<div class="text-info">
...
$("#LikBasket").click(function(){
	...
	var pro_list = $("input[name='pro_list']").val();
	var buy_num = $("input[name='buy_num']").val();
	// alert(buy_num)
	if(goods_id!=""&&pro_list!=""&&buy_num!=0){
		$.ajax({
			type:"post",
			url:"<?php echo U('Cart/add_cart');?>",
			data:{
				goods_id,pro_list,buy_num
			},
			dataType:"json",
			success:function(msg){
				if(msg.error==0){
					$("#J_MiniCartNum").text(msg.count)
					$("#buy_").text(msg.count)
				}
			}
		})
				...
				<div class="match">
					...
					<div class="match-comment">
						<ul class="like_list">
							<li>
								<div class="s_picBox">
									<a class="s_pic" href="#"><img src="/shop/tp/Public/Home/images/cp.jpg"></a>
							...
							<li>
								<div class="s_picBox">
									<a class="s_pic" href="#"><img src="/shop/tp/Public/Home/images/cp2.jpg"></a>
					    ...
					    <div class="mc"> 
						     <ul>					    
						     	<div class="mt">            
							      ...
							      <li class="first">
							      	<div class="p-img">                    
							      		<a  href="#"> <img class="" src="/shop/tp/Public/Home/images/browse1.jpg"> </a>               
							      	</div>
								...
								<div class="am-tab-panel am-fade am-in am-active">
									...
									<div class="details">
										...
										<div class="twlistNews">
											<img src="/shop/tp/Public/Home/images/tw1.jpg" />
											<img src="/shop/tp/Public/Home/images/tw2.jpg" />
											<img src="/shop/tp/Public/Home/images/tw3.jpg" />
											<img src="/shop/tp/Public/Home/images/tw4.jpg" />
											<img src="/shop/tp/Public/Home/images/tw5.jpg" />
											<img src="/shop/tp/Public/Home/images/tw6.jpg" />
											<img src="/shop/tp/Public/Home/images/tw7.jpg" />
										</div>
									</div>
									<div class="clear"></div>
								...
								<div class="am-tab-panel am-fade">
									...
									<ul class="am-comments-list am-comments-list-flip">
										<li class="am-comment">
											<!-- 评论容器 -->
											<a href="">
												<img class="am-comment-avatar" src="/shop/tp/Public/Home/images/hwbn40x40.jpg" />
												<!-- 评论者头像 -->
											</a>
										...
										<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
											<li>
												<div class="i-pic limit">
													<img src="/shop/tp/Public/Home/images/imgsearch1.jpg" />
