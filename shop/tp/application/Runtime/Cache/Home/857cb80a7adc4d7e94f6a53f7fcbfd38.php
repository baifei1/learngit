...
<?php if(is_array($category)): foreach($category as $key=>$v): ?><li class="appliance js_toggle relative first">
<div class="category-info">
<h3 class="category-name b-category-name"><i><img src="/shop/tp/Public/Home/images/cake.png"></i><a class="ml-22" title="点心"><?php echo ($v["cat_name"]); ?></a></h3>
<em>&gt;</em></div>
...
<div class="area-in">
	<div class="area-bg">
		<div class="menu-srot">
			<div class="sort-side">
				<?php if(is_array($v['son'])): foreach($v['son'] as $key=>$son): ?><dl class="dl-sort">
					<dt><span title="蛋糕"><?php echo ($son["cat_name"]); ?></span></dt>
					<?php if(is_array($son['son'])): foreach($son['son'] as $key=>$sons): ?><dd><a title="蒸蛋糕" href="#"><span><?php echo ($sons["cat_name"]); ?></span></a></dd><?php endforeach; endif; ?>
...
<b class="arrow"></b>	
					...
					<div class="am-g am-g-fixed smallnav">
						<div class="am-u-sm-3">
							<a href="sort.html"><img src="/shop/tp/Public/Home/images/navsmall.jpg" />
								<div class="title">商品分类</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="/shop/tp/Public/Home/images/huismall.jpg" />
								<div class="title">大聚惠</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="/shop/tp/Public/Home/images/mansmall.jpg" />
								<div class="title">个人中心</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="/shop/tp/Public/Home/images/moneysmall.jpg" />
					...
					<div class="marqueen">
						...
						<div class="demo">
							...
							<ul>
								<li class="title-first"><a target="_blank" href="#">
									<img src="/shop/tp/Public/Home/images/TJ2.jpg"></img>
									<span>[特惠]</span>商城爆品1分秒								
								</a></li>
								<li class="title-first"><a target="_blank" href="#">
									<span>[公告]</span>商城与广州市签署战略合作协议
								     <img src="/shop/tp/Public/Home/images/TJ.jpg"></img>
						...
						<div class="mod-vip">
							<div class="m-baseinfo">
								<a href="person/index.html">
									<img src="/shop/tp/Public/Home/images/getAvatar.do.jpg">
								</a>
								<em>
								<?php if(isset($_SESSION['user']['user_name'])){?>
									Hi,<span class="s-name"><?php echo $_SESSION['user']['user_name'];?></span>
									<?php }else{?>
							...
							<?php if($_SESSION['user'] == '' ): ?><a class="am-btn-warning btn" href="<?php echo U('Login/index');?>">登录</a>
								<a class="am-btn-warning btn" href="<?php echo U('Login/register');?>">注册</a><?php endif; ?>
							</div>
                        ...
                        <div class="advTip"><img src="/shop/tp/Public/Home/images/advTip.jpg"/></div>
						</div>
					</div>
					<div class="clear"></div>
				</div>
				...
				<div class="shopMain" id="shopmain">
					...
					<div class="am-g am-g-fixed recommendation">
						<div class="clock am-u-sm-3" ">
							<img src="/shop/tp/Public/Home/images/2016.png "></img>
							<p>今日<br>推荐</p>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							...
							<div class="recommendationMain one">
								<a href="introduction.html"><img src="/shop/tp/Public/Home/images/tj.png "></img></a>
							</div>
						</div>						
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain two">
								<img src="/shop/tp/Public/Home/images/tj1.png "></img>
							</div>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain three">
								<img src="/shop/tp/Public/Home/images/tj2.png "></img>
							</div>
						</div>
					  ...
					  <div class="am-g am-g-fixed ">
						<div class="am-u-sm-3 ">
							...
							<div class="activityMain ">
								<img src="/shop/tp/Public/Home/images/activity1.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>						
						...
						<div class="am-u-sm-3 ">
						  <div class="icon-sale two "></div>	
							<h4>特惠</h4>
							<div class="activityMain ">
								<img src="/shop/tp/Public/Home/images/activity2.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>								
							</div>							
						...
						<div class="am-u-sm-3 ">
							...
							<h4>团购</h4>
							<div class="activityMain ">
								<img src="/shop/tp/Public/Home/images/activity3.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>							
						...
						<div class="am-u-sm-3 last ">
							...
							<h4>超值</h4>
							<div class="activityMain ">
								<img src="/shop/tp/Public/Home/images/activity.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>													
						...
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							...
							<a href="# ">
								<div class="outer-con ">
                                  ...
                                  <img src="/shop/tp/Public/Home/images/act1.png " />								
							</a>
							<div class="triangle-topright"></div>						
						</div>
						<?php if(is_array($res)): foreach($res as $key=>$v): ?><div class="am-u-sm-7 am-u-md-4 text-two">
								<div class="outer-con ">
									<div class="title ">
								...
								<a href="<?php echo U('Goods/goods_info',array('goods_id'=>$v['goods_id']));?>">
								<img src="/shop/tp/<?php echo ($v["goods_thumb"]); ?>" style="height: 180px"></a>
                 ...
                 <div class="clear "></div>  
					...
					<div class="am-g am-g-fixed floodThree ">
						...
						<div class="am-u-sm-4 text-four">
							<a href="# ">
								<img src="/shop/tp/Public/Home/images/6.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>								
						...
						<div class="am-u-sm-4 text-four sug">
							<a href="# ">
								<img src="/shop/tp/Public/Home/images/7.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>
						...
						<div class="am-u-sm-6 am-u-md-3 text-five big ">
							<a href="# ">
								<img src="/shop/tp/Public/Home/images/10.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>		
						...
						<div class="am-u-sm-6 am-u-md-3 text-five ">
							<a href="# ">
								<img src="/shop/tp/Public/Home/images/8.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>	
						...
						<div class="am-u-sm-6 am-u-md-3 text-five sug">
							<a href="# ">
								<img src="/shop/tp/Public/Home/images/9.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>
